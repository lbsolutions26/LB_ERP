...
const listPath = "scripts/_drive-files-full.json";
const outDir = "scripts/_produto_images";
...
async function downloadOne(file, attempt = 1) {
  ...
  // Google sometimes returns HTML virus scan page for large files
...
if (failures.length) {
  fs.writeFileSync("scripts/_drive-download-failures.json", JSON.stringify(failures, null, 2));
}
